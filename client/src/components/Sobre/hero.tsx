...
const Hero: React.FC = () => {
  useEffect(() => {
    ...
    if (rainContainer) {
      for (let i = 0; i < 160; i++) {
        ...
        rainElement.textContent = String.fromCharCode(Math.random() * 26 + 65);
  ...
  return (
    <section className="bg-gray-900 h-full flex flex-col justify-center items-center text-white relative overflow-hidden transition- duration-150">
